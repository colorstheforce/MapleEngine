...
namespace Maple
{
    ...
    auto ImGuiManager::onUpdate(const Timestep& delta) -> void
    {
        ImGui::Render();
    }
    auto ImGuiManager::onRender(Scene* scene) -> void
    {
        imguiRender->render(nullptr);
    }


	auto ImGuiManager::addIcon() -> void
	{
		ImGuiIO& io = ImGui::GetIO();
	...
	auto ImGuiManager::onResize(uint32_t w, uint32_t h) -> void
	{
		imguiRender->onResize(w, h);
	}

	auto ImGuiManager::setTheme() -> void
	{
